...
import example.tacademy.miniproject.data.NetworkResultTemp;
...
public class SignUpRequest extends AbstractRequest<NetworkResult<User>> {
    ...
    public SignUpRequest(Context context, String username, String password, String email, String regId) {
